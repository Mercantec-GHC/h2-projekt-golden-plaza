...
const Tickets = () => {
    ...
    //function to create a new ticket, need to communicate with keycloak since function requires login
    ...
    //edit a ticket in case you got some info wrong or want to change status, requires keycloak login
    ...
    //deleting/removing a ticket this could be made automatic later based on ticketstatus, requires keycloak login
    ...
    //simple design for the ticket display
    return (
                                                ...
                                                <li key={ticket.id} style={noBullets}>
                                                    {editTicket?.id === ticket.id ? (
                                                        <div>
                                                            ...
                                                            >
                                                                {/*change the below values in case you want to add more or new ticket status*/}
